...
class Oxfords extends StatefulWidget {
  const Oxfords({Key? key}) : super(key: key);

  @override
  State<Oxfords> createState() => _JordanState();
}

class _JordanState extends State<Oxfords> {
  @override
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: Image.asset('assets/shoes_/oxford1.jpg').image,
                              fit: BoxFit.cover,
                            ),
                          ),
                          child: const Padding(
                  ...
                  child: MaterialButton(
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: Image.asset('assets/shoes_/oxford2.jpg').image,
                              fit: BoxFit.cover,
                            ),
                          ),
                          child: const Padding(
