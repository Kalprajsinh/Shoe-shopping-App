...
class Loafers extends StatefulWidget {
  const Loafers({Key? key}) : super(key: key);

  @override
  State<Loafers> createState() => _JordanState();
}

class _JordanState extends State<Loafers> {
  @override
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: Image.asset('assets/shoes_/loafer1.jpg').image,
                              fit: BoxFit.cover,
                            ),
                          ),
                          child: const Padding(
                  ...
                  child: MaterialButton(
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: Image.asset('assets/shoes_/loafer2.jpg').image,
                              fit: BoxFit.cover,
                            ),
                          ),
                          child: const Padding(
