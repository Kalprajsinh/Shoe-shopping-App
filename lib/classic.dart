...
class Classic extends StatefulWidget {
  ...
  @override
  State<Classic> createState() => _JordanState();
}

class _JordanState extends State<Classic> {
  @override
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: Image.asset('assets/shoes_/classic1.jpg').image,
                              fit: BoxFit.cover,
                            ),
                          ),
                          child: const Padding(
                  ...
                  child: MaterialButton(
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: Image.asset('assets/shoes_/classic2.jpg').image,
                              fit: BoxFit.cover,
                            ),
                          ),
                          child: const Padding(
